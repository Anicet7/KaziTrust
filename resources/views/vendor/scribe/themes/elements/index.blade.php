...
<head>
    ...
    <link href="https://cdnjs.cloudflare.com/ajax/libs/prism-themes/1.9.0/prism-onedark.min.css" rel="stylesheet" />
    <link href="https://cdnjs.cloudflare.com/ajax/libs/prism-themes/1.9.0/prism-nord.min.css" rel="stylesheet" />
    ...
    @endif
        ...
        <style>
        /* Forcer le mode sombre général et la typographie */
        body, html {
            background-color: #0f172a; /* Slate 900 pour le contenu principal */
            color: #e2e8f0; /* Texte clair lisible */
        }

        /* Barre de navigation gauche (Palette KaziTrust) */
        .toc-wrapper {
            background-color: #020617 !important; /* Slate 950 */
        }
        
        .toc-wrapper .toc-link {
            color: #94a3b8 !important; /* Texte des liens */
        }
        
        .toc-wrapper .toc-link.active, 
        .toc-wrapper .toc-link:hover {
            color: #ffffff !important;
            background-color: #0047AB !important; /* Bleu Cobalt au survol/actif */
            border-left: 4px solid #3b82f6; /* Accent visuel */
        }

        /* Badges des méthodes HTTP */
        .badge--POST {
            background-color: #10b981 !important; /* Vert vif */
            color: #ffffff !important;
        }
        .badge--GET {
        ...
        /* Zone de code à droite (si layout classique Scribe) */
        .page-wrapper .dark-box {
            background-color: #1e1e2e !important; /* Fond sombre pour la colonne de code */
        }
    </style>
